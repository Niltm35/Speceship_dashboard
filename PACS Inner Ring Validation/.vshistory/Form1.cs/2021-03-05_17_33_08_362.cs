...
namespace PACS_Inner_Ring_Validation
{
    public partial class Form1 : Form
    {
        ...
        private void ping()
        {
            ...
            string SELECT_IP = "SELECT IPPlanet FROM Planets where idPlanet = " + comboPlanets.SelectedValue;
            string TAULA_IP = "Planets";
            string IP_Planet = bbdd.PortarPerTaula(TAULA_IP, SELECT_IP).Rows[0][0].ToString();

            string SELECT_PORT = "SELECT PortPlanet FROM Planets where idPlanet = " + comboPlanets.SelectedValue;
            string TAULA_PORT = "Planets";
            string Port_Planet = bbdd.PortarPerTaula(TAULA_PORT, SELECT_PORT).Rows[0][0].ToString();
            ...
            if (xarxaDisponible)
            {
                ...
                for (int i = 1; i <= 10; i++)
                {
                    ...
                    lbx_console.Items.Add("Ping" + i + " to" + comboPlanets.SelectedText.ToString() + " - " + Estado);
                    Thread.Sleep(100);
                }
