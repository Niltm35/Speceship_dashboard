...
namespace PACS_Inner_Ring_Validation
{
    public partial class Form1 : Form
    {
        ...
        private void ping()
        {
            ...
            string SELECT_IP = "SELECT IPPlanet FROM spaceshipboard where idPlanet = " + comboPlanets.SelectedValue;
            string TAULA_IP = "spaceshipboard";
            string IP_Planet = bbdd.PortarPerTaula(TAULA_IP, SELECT_IP).Rows[0][0].ToString();

            string SELECT_PORT = "SELECT IPPlanet FROM spaceshipboard where idPlanet = " + comboPlanets.SelectedValue;
            string TAULA_PORT = "spaceshipboard";
