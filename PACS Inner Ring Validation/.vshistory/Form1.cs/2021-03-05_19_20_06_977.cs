...
namespace PACS_Inner_Ring_Validation
{
    public partial class Form1 : Form
    {
        ...
        public string dd(string IP_Planet)
        {
            string SELECT_IP = "SELECT * FROM Planets where idPlanet = " + 1;//comboPlanets.SelectedValue;
            string TAULA_IP = "Planets";
            IP_Planet = bbdd.PortarPerTaula(TAULA_IP, SELECT_IP).Rows[0][10].ToString();
            Port_Planet = bbdd.PortarPerTaula(TAULA_IP, SELECT_IP).Rows[0][11].ToString();

            string SELECT_PORT = "SELECT PortPlanet FROM Planets where idPlanet = " + comboPlanets.SelectedValue;
            string TAULA_PORT = "Planets";
            Port_Planet = bbdd.PortarPerTaula(TAULA_PORT, SELECT_PORT).Rows[0][0].ToString();
            return (IP_Planet/*, Port_Planet*/);
        }
