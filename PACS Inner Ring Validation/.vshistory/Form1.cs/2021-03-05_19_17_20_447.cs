...
namespace PACS_Inner_Ring_Validation
{
    public partial class Form1 : Form
    {
        ...
        {
            string SELECT_IP = "SELECT IPPlanet FROM Planets where idPlanet = " + 1;//comboPlanets.SelectedValue;
            string TAULA_IP = "Planets";
            IP_Planet = bbdd.PortarPerTaula(TAULA_IP, SELECT_IP).Rows[0][0].ToString();
