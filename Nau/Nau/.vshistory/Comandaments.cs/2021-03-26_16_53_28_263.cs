...
namespace Nau
{
    public partial class Comandaments : Form
    {
        ...
        public String TaulaDescodificar(string codi_letra)
        {
        ...
        private void descodificacion_zip()
        {
            ...
            StreamWriter sw = new StreamWriter(extractPath + "PACS_des" + n, true, Encoding.ASCII);

            string text = File.ReadAllText(extractPath + "\\PACS" + n ".txt");
            //string txt_descod = "";
            ...
            while (leido < text.Length)
            {
                ...
                string letra = TaulaDescodificar(codi);

                sw.Write(letra);

                //txt_descod = txt_descod + letra;
