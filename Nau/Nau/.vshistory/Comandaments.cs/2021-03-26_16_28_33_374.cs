...
namespace Nau
{
    public partial class Comandaments : Form
    {
        ...
        {
            string SELECT = "SELECT * FROM InnerEncryptionData where Numbers = '" + codi_letra + "' AND IdInnerEncryption = '" + comboPlanet.SelectedValue + "'";
        ...
        {
            string extractPath = Application.StartupPath + @"\Fitxers\PACS_nau.zip";
