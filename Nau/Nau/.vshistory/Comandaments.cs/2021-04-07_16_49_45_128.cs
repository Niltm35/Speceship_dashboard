...
namespace Nau
{
    public partial class Comandaments : Form
    {
        ...
        //----- libreria dodificada -----
        //public DataSet TaulaDescodificar()
        //{
        ...
        private void LibreriaCode()
        {
            ...
            //foreach (int item in hola.Rows)
            //{
            //    codificacio codi = new codificacio();
            //    codi.valor = hola.Rows[item][1].ToString();
            //    codi.lletra = hola.Rows[item][0].ToString();
            //    codis.Add(codi);
            //}

            List<DataRow> list = hola.AsEnumerable().ToList();
        }
        ...
        private void proceso_descodificar(string num)
        {
            //try {

            //    DataSet DataSet1 = TaulaDescodificar();
            //    DataTable table = DataSet1.Tables["Numbers"];
