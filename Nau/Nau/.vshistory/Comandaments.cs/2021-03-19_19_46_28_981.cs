...
namespace Nau
{
    public partial class Comandaments : Form
    {
        ...
        private void SendVK(byte[] t)
        {
            ...
            (Math.Ceiling(Convert.ToDouble(t.Length) / Convert.ToDouble(BufferSize)));
            ////progressBar1.Maximum = NoOfPackets;
            int TotalLength = t.Length, CurrentPacketLength, counter = 0;
            for (int i = 0; i < NoOfPackets; i++)
            {
                ...
                //t.Read(SendingBuffer, 0, CurrentPacketLength);
            ...
            //Fs.Close();
            ns_vk.Close();
            lbx_Missatges.Items.Add("YOU: " + t.ToString());
