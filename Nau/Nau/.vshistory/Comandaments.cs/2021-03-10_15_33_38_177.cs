...
namespace Nau
{
    public partial class Comandaments : Form
    {
        ...
        public DataSet dd()
        {
            string SELECT = "SELECT * FROM SpaceShips where idPlanet = " + comboPlanet.SelectedValue;
        ...
        {
            IP_Planet = dd().Tables[0].Rows[0][3].ToString();
            Port_Planet = dd().Tables[0].Rows[0][4].ToString();
        }
