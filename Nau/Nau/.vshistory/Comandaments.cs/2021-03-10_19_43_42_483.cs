...
namespace Nau
{
    public partial class Comandaments : Form
    {
        ...
        private void Comandaments_Load(object sender, EventArgs e)
        {
            ...
            string select_Nau = "SELECT * FROM Planets ORDER BY DescPlanet ASC";
            string taula_Nau = "Planets";
            DataTable dt_Nau = bbdd.PortarPerTaula(taula_Nau, select_Nau);
            comboPlanet.DataSource = dt_Nau;

            string select_Delivery = "SELECT * FROM Planets ORDER BY DescPlanet ASC";
            string taula_Delivery = "Planets";
        ...
        {
            string query = "SELECT ValidationCode FROM InnerEncryption where idPlanet = " + comboPlanet1.SelectedValue;
            string taula = "InnerEncryption";
            ValidationCode.Text = bbdd.PortarPerTaula(taula,query).Rows[0][0].ToString();

            string query_key = "SELECT XMLKey FROM PlanetKeys where idPlanet = " + comboPlanet1.SelectedValue;
        ...
        {
            string SELECT = "SELECT * FROM Planets where idPlanet = " + comboPlanet1.SelectedValue;
        ...
        {
            string SELECT = "SELECT * FROM SpaceShips where idSpaceShipType = " + comboNau1.SelectedValue;
        ...
        {
            string SELECT = "SELECT * FROM DeliveryData where idSpaceShipType = " + comboNau1.SelectedValue;
