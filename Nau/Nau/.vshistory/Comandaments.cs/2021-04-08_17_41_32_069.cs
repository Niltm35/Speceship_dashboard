    ...
    public partial class Comandaments : Form
    {
        ...
        private void SendMessage(string Smessage)
        {
            ...
            catch
            {
                ...
                lbl_INFO.Text = "Servidor inaccessible";
        ...
        public void message_planet(string ms)
        {
            ...
            string imag = Application.StartupPath + @"\imatges";
            ...
            if (request == "VR")
            {
                if (answer == "VP")
                {
                    ...
                    //Form1 _info = new Form1();
                    //_info.INFO = Message;
                    //_info.ICON = "info_icon.png";
                    //_info.Show();

                    lbl_INFO.Text = "Validation ln Progress";
                    img_INFO.BackgroundImage = Image.FromFile(imag + @"\info_icon.png");
                    img_INFO.BackgroundImageLayout = ImageLayout.Stretch;
                    gif_info.URL = imag + @"\inf2.gif";
