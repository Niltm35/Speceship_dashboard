...
namespace Nau
{
    public partial class Comandaments : Form
    {
        ...
        public DataSet dd(string TAULA)
        {
            string SELECT = "SELECT * FROM "+ TAULA + " where idPlanet = " + comboPlanet.SelectedValue;
        ...
        {
            IP_Planet = dd(TAULA).Tables[0].Rows[0][10].ToString();
            Port_Planet = dd(TAULA).Tables[0].Rows[0][11].ToString();
        }
